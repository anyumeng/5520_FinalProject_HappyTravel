...
import edu.northeastern.cs5520.numadfa21_happytravel.recommendationadapter.NatureAdapter;
...
public class NatureFragment extends Fragment{
    ...
    public static NatureFragment newInstance(List<TravelHistory> mapList) {
